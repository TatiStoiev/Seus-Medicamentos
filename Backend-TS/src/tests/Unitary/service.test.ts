...
describe('Tests for the service layer', () => {
    ...
    describe('Tests for create medicine', async function () {

        it('Should create a medicine successfully', async function () {
    ...
    describe('Tests for search medicine by name', async function () {
        ...
        it('Should find the medicine by name successfully', async function () {

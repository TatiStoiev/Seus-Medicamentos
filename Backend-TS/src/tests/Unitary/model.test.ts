...
describe('Tests for the model layer', () => {
    ...
    describe('Tests for search the medicine by name', async function () {

        it('Should find a medicine by name successfully', async function () {
    ...
    describe('Tests for search the medicine by active principle', async function () {

        it('Should find the medicine by active principle successfully', async function () {
            sinon.stub(SequelizeMedicine, 'findOne').resolves(mockMedicineFindByNameWithId as any);
